...
func main() {
	...
	for {
		...
		case <-time.After(5 * time.Second):
			...
			fmt.Println(err)
			fmt.Fprintf(file, "<html><body>"+time.Now().Format("2006-01-02 15:04:05.999999999")+" at "+podname+"</body></html>")
			file.Close()
		}
	}
}
...
//docker build -t vincen320/go-stateful:1 -t vincen320/go-stateful:latest .
